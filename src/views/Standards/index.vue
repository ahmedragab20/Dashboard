              ...
              >
                ...
                <td>
                  <div class="d-flex align-center">
                    ...
                    <v-list-item
                      class="pa-0"
                      :color="complationRateColor(item.rate * 100)"
                    >
                      {{ item.rate * 100 }}%
                    </v-list-item>
                  </div>
                ...
                <td>
                  <div class="text-h6 d-flex align-center" style="gap: 5px">
                    ...
                    >
                    <span class="text-primary">الاسئلة</span>
                  </div>
                </td>
              </tr>
            </tbody>
...
const items = ref([
  ...
  {
    standard: "معيار البيئة",
    gov: "هيئة تطوير المدينة المنورة",
    startDate: "07/01/2021",
    endDate: "07/01/2022",
    status: { id: 3, name: "ملغي" },
    rate: 0.0,
  },
  {
    standard: "معيار الجودة",
