    ...
    <v-card outlined min-height="70vh" class="pa-4">
      ...
      <v-row>
        <v-col cols="4" v-for="item in Items" :key="i">
          <v-card
            style="border: 3px solid lightblue; border-radius: 5px"
            class="pa-0"
            outlined
          >
            <v-card-title
            ...
            <!-- <v-card-text
              >يجب الا تكون كلمه عاديةو ويجب ان تتضمن مجموعة من الاحرف والارقام
              والرموز الخاصة فى الدورات التدريبيه التى نقدمها نعلم المتدربيين
              حيلا بسيطة لانشاء كلمات مرور ذكية يسهل تذكرهاز</v-card-text
            > -->
            <v-card-text>{{ item.ans }} </v-card-text>
